<?php 
echo "The World Is Your! - Scarface";
...
$quotes = array("no, provare no. Fare o non fare. Non c’è provare (Yoda in Star Wars - Il ritorno dello Jedi)",
                ...
                "La vita scappa via in fretta. Se uno non si ferma e non si guarda attorno, rischia di sprecarla. (Ferris in Una pazza giornata di vacanza)",
                "Molti di quelli che vivono meritano la morte, e molti di quelli che muoiono meritano la vita. Tu sei in grado di valutare, Frodo? Non essere troppo ansioso di elargire morte e giudizi. Anche i più saggi non conoscono tutti gli esiti. (Gandalf in Il Signore degli Anelli - La compagnia dell’anello)",
                "Oh, sì. Il passato può fare male, ma a mio modo di vedere dal passato puoi scappare oppure imparare qualcosa. (Rafiki ne Il Re Leone)",
                "Non si vive per accontentare gli altri. La scelta deve essere solo tua. Perché quando andrai ad affrontare quella creatura, ci dovrai andare da sola. (La Regina Bianca in Alice in Wonderland)",
                "Io voglio che voi invitiate il “sì” nella vostra vita, perché il “sì”, a sua volta, vi risponderà sì! Quando voi dite sì, entrate nella sfera del possibile!” (Terrence Bundley in Yes Man)",
                "Noi siamo quello che scegliamo di essere. Ora scegli! (Goblin in Spiderman)",
                ...
                "Smettila di pensare a quello che vogliono gli altri. Non pensare a quello che voglio io, a quello che vuole lui o a quello che vogliono i tuoi. Tu che cosa vuoi? (Noah in Le pagine della nostra vita)",
                "Se hai intenzione di provare, vai fino in fondo. Altrimenti non cominciare neanche. Potrebbe voler dire perdere la ragazza, la moglie, i parenti, il lavoro, e forse anche la testa.
                  ...
                  Dopotutto, domani è un altro giorno. (Rossella O'Hara in Via col vento)",
                "La vita è avere coraggio e affrontare l'ignoto. Trovarsi l'un l'altro e sentirsi. È questo lo scopo della vita. (da I sogni segreti di Walter Mitty)",
                "Non sono le nostre capacità che dimostrano chi siamo davvero, sono le nostre scelte. (Silente in Harry Potter e la Camera dei segreti)",
                "La nostra vita è fatta di occasioni, anche di quelle che abbiamo perso. (da Il curioso caso di Benjamin Button)",
                "La felicità è reale solo se viene condivisa. (da Into the wild – Nelle terre selvagge)",
                ...
                "Hey! Non permettere mai a nessuno di dirti che non sai fare qualcosa. Neanche a me. Ok? Se hai un sogno tu lo devi proteggere. Quando le persone non sanno fare qualcosa lo dicono a te che non la sai fare. Se vuoi qualcosa, vai e inseguila. Punto. (Chris in La ricerca della felicità)",
                "Non pensare mai di non meritare ciò che vuoi! (Patrick in Dieci cose che odio di te)",
                "Dopo un po’ impari a ignorare il nome che ti danno e ti fidi solo di chi sei! Ognuno di voi è ostacolo di se stesso… (Shrek terzo)",
                "Vuoi dire che Dio è vanitoso? No, non è vanitoso. Vuole godersi le cose belle con noi. Io credo che Dio si incazza se tu, di fronte al colore viola di un campo di fiori, neanche te ne accorgi. (Celie e Shug Avery ne Il colore Viola)",
